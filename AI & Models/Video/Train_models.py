...
output_path = "Saved Processed Data and Models/court_trial 100x64x64x1"
...
md.train_model(X_train, X_test, y_train, y_test , output_path = output_path, model = cnn_3d, name = "CNN_3D", batch_size= 4)
