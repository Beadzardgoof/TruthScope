...
def train_model_dl(model, output_path, X_train, y_train, X_test, y_test, name = "model" , batch_size = 8, epochs = 30, use_validation_set = False):
    if not os.path.exists(output_path):
        os.makedirs(output_path)
    
    # Further split test data into test and validation sets if required.
